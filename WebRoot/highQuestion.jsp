...
<c:if test="${requestScope.highQuestion==null}">
	<jsp:forward page="questionServlet?flag=highQuestion"></jsp:forward>
</c:if>
        ...
        <div style="width:75%;height:820px;border:1px #999 solid;">
        	...
        	<div class="top">
        		<ul class="topul">
        			...
        			<li><a href="questionAction_highQuestion.action"  style="color:#999">高分问题</a></li>
        	...
        	<table class="notAnswerQuestion">
        		...
        		<tbody>
        			<c:forEach items="${highQuestion}" var="question">
        				<tr>
